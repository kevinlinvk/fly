...
bool cdr_serialize_px4__msg__PositionSetpoint(
  const px4__msg__PositionSetpoint * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_px4__msg__PositionSetpoint(
  eprosima::fastcdr::Cdr & cdr,
  px4__msg__PositionSetpoint * ros_message);
...
bool cdr_serialize_key_px4__msg__PositionSetpoint(
  const px4__msg__PositionSetpoint * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_px4__msg__PositionSetpoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_px4__msg__PositionSetpoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_px4__msg__PositionSetpointTriplet(
  const px4__msg__PositionSetpointTriplet * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: previous
  {
    cdr_serialize_px4__msg__PositionSetpoint(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_deserialize_px4__msg__PositionSetpointTriplet(
  eprosima::fastcdr::Cdr & cdr,
  px4__msg__PositionSetpointTriplet * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  ...
  // Field name: previous
  {
    cdr_deserialize_px4__msg__PositionSetpoint(cdr, &ros_message->previous);
  }

  // Field name: current
  {
    cdr_deserialize_px4__msg__PositionSetpoint(cdr, &ros_message->current);
  }

  // Field name: next
  {
    cdr_deserialize_px4__msg__PositionSetpoint(cdr, &ros_message->next);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_serialize_key_px4__msg__PositionSetpointTriplet(
  const px4__msg__PositionSetpointTriplet * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
  ...
  // Field name: previous
  {
    cdr_serialize_key_px4__msg__PositionSetpoint(
      &ros_message->previous, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t get_serialized_size_key_px4__msg__PositionSetpointTriplet(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PositionSetpointTriplet__ros_msg_type * ros_message = static_cast<const _PositionSetpointTriplet__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: previous
  current_alignment += get_serialized_size_key_px4__msg__PositionSetpoint(
    &(ros_message->previous), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_key_px4__msg__PositionSetpointTriplet(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: previous
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_px4__msg__PositionSetpoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4__msg__PositionSetpointTriplet * ros_message = static_cast<const px4__msg__PositionSetpointTriplet *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4__msg__PositionSetpointTriplet(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4__msg__PositionSetpointTriplet * ros_message = static_cast<px4__msg__PositionSetpointTriplet *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4__msg__PositionSetpointTriplet(cdr, ros_message);
}
