...
// IWYU pragma: private, include "px4/msg/uavcan_parameter_request.hpp"
...
inline void to_yaml(
  const px4::msg::UavcanParameterRequest & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::UavcanParameterRequest & msg)
{
