...
// IWYU pragma: private, include "px4/msg/gimbal_manager_status.hpp"
...
inline void to_yaml(
  const px4::msg::GimbalManagerStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::GimbalManagerStatus & msg)
{
