...
// IWYU pragma: private, include "px4/msg/internal_combustion_engine_status.hpp"
...
inline void to_yaml(
  const px4::msg::InternalCombustionEngineStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::InternalCombustionEngineStatus & msg)
{
