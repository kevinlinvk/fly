...
// IWYU pragma: private, include "px4/msg/control_allocator_status.hpp"
...
inline void to_yaml(
  const px4::msg::ControlAllocatorStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::ControlAllocatorStatus & msg)
{
