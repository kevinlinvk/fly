...
// IWYU pragma: private, include "px4/msg/estimator_sensor_bias.hpp"
...
inline void to_yaml(
  const px4::msg::EstimatorSensorBias & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::EstimatorSensorBias & msg)
{
