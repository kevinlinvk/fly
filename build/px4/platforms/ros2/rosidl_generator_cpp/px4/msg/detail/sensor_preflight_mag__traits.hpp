...
// IWYU pragma: private, include "px4/msg/sensor_preflight_mag.hpp"
...
inline void to_yaml(
  const px4::msg::SensorPreflightMag & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::SensorPreflightMag & msg)
{
