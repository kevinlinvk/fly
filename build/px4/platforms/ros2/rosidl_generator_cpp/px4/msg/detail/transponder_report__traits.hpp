...
// IWYU pragma: private, include "px4/msg/transponder_report.hpp"
...
inline void to_yaml(
  const px4::msg::TransponderReport & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::TransponderReport & msg)
{
