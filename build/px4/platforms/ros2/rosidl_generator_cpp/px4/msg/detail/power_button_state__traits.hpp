...
// IWYU pragma: private, include "px4/msg/power_button_state.hpp"
...
inline void to_yaml(
  const px4::msg::PowerButtonState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::PowerButtonState & msg)
{
