...
{
  new (message_memory) px4::msg::RegisterExtComponentReply(_init);
}

void RegisterExtComponentReply_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::RegisterExtComponentReply *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RegisterExtComponentReply_message_member_array[8] = {
  {
    ...
    offsetof(px4::msg::RegisterExtComponentReply, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RegisterExtComponentReply, request_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    25,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RegisterExtComponentReply, name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RegisterExtComponentReply, px4_ros2_api_version),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RegisterExtComponentReply, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RegisterExtComponentReply, arming_check_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RegisterExtComponentReply, mode_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RegisterExtComponentReply, mode_executor_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RegisterExtComponentReply_message_members = {
  ...
  8,  // number of fields
  sizeof(px4::msg::RegisterExtComponentReply),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RegisterExtComponentReply_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, RegisterExtComponentReply)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RegisterExtComponentReply_message_type_support_handle;
}
