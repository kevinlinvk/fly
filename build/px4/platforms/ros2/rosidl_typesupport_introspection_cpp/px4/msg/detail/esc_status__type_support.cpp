...
{
  const auto & item = *reinterpret_cast<const px4::msg::EscReport *>(
    get_const_function__EscStatus__esc(untyped_member, index));
  auto & value = *reinterpret_cast<px4::msg::EscReport *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<px4::msg::EscReport *>(
    get_function__EscStatus__esc(untyped_member, index));
  const auto & value = *reinterpret_cast<const px4::msg::EscReport *>(untyped_value);
  item = value;
}
