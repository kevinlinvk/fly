...
#include "px4/msg/detail/rover_velocity_setpoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::RoverVelocitySetpoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::RoverVelocitySetpoint & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::RoverVelocitySetpoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4::msg::RoverVelocitySetpoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::RoverVelocitySetpoint *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_RoverVelocitySetpoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, RoverVelocitySetpoint)() {
  return &px4::msg::typesupport_fastrtps_cpp::_RoverVelocitySetpoint__handle;
}
