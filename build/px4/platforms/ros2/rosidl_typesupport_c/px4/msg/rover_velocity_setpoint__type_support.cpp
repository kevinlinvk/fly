...
#include "px4/msg/detail/rover_velocity_setpoint__type_support.h"
...
static const _RoverVelocitySetpoint_type_support_symbol_names_t _RoverVelocitySetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, RoverVelocitySetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, RoverVelocitySetpoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, RoverVelocitySetpoint)() {
  return &::px4::msg::rosidl_typesupport_c::RoverVelocitySetpoint_message_type_support_handle;
}
