  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xa6, 0x54, 0x06, 0xce, 0x52, 0x6b, 0x61, 0x40,
      0xdd, 0x49, 0x41, 0x9f, 0x91, 0xa5, 0xb0, 0x16,
      0x69, 0xba, 0x25, 0x2b, 0x1f, 0xf5, 0x4b, 0x02,
      0x1d, 0xfd, 0xdd, 0x34, 0x54, 0xb5, 0x88, 0xb6,
    }};
  return &hash;
}
...
static char px4__msg__VehicleGlobalPosition__FIELD_NAME__lat_lon_valid[] = "lat_lon_valid";
static char px4__msg__VehicleGlobalPosition__FIELD_NAME__alt_valid[] = "alt_valid";
static char px4__msg__VehicleGlobalPosition__FIELD_NAME__delta_alt[] = "delta_alt";
static char px4__msg__VehicleGlobalPosition__FIELD_NAME__delta_terrain[] = "delta_terrain";
...
static char px4__msg__VehicleGlobalPosition__FIELD_NAME__terrain_reset_counter[] = "terrain_reset_counter";
...
static rosidl_runtime_c__type_description__Field px4__msg__VehicleGlobalPosition__FIELDS[] = {
  ...
  {
    {px4__msg__VehicleGlobalPosition__FIELD_NAME__lat_lon_valid, 13, 13},
    {
  ...
  {
    {px4__msg__VehicleGlobalPosition__FIELD_NAME__alt_valid, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {px4__msg__VehicleGlobalPosition__FIELD_NAME__delta_terrain, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4__msg__VehicleGlobalPosition__FIELD_NAME__terrain_reset_counter, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT8,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4__msg__VehicleGlobalPosition__FIELDS, 18, 18},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
