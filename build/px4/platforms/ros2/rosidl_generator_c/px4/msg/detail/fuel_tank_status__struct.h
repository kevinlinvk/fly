...
#ifndef PX4__MSG__DETAIL__FUEL_TANK_STATUS__STRUCT_H_
#define PX4__MSG__DETAIL__FUEL_TANK_STATUS__STRUCT_H_
...
enum
{
  px4__msg__FuelTankStatus__MAV_FUEL_TYPE_UNKNOWN = 0
};
...
enum
{
  px4__msg__FuelTankStatus__MAV_FUEL_TYPE_LIQUID = 1
};
...
enum
{
  px4__msg__FuelTankStatus__MAV_FUEL_TYPE_GAS = 2
};

/// Struct defined in msg/FuelTankStatus in the package px4.
typedef struct px4__msg__FuelTankStatus
{
...
// Struct for a sequence of px4__msg__FuelTankStatus.
typedef struct px4__msg__FuelTankStatus__Sequence
{
...
#endif  // PX4__MSG__DETAIL__FUEL_TANK_STATUS__STRUCT_H_
