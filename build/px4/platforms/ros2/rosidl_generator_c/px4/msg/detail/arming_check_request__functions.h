...
#ifndef PX4__MSG__DETAIL__ARMING_CHECK_REQUEST__FUNCTIONS_H_
#define PX4__MSG__DETAIL__ARMING_CHECK_REQUEST__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__ArmingCheckRequest__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__ArmingCheckRequest *
px4__msg__ArmingCheckRequest__create(void);

/// Destroy msg/ArmingCheckRequest message.
/**
 * It calls
 * px4__msg__ArmingCheckRequest__fini()
 ...
 * px4__msg__ArmingCheckRequest__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__ArmingCheckRequest__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__ARMING_CHECK_REQUEST__FUNCTIONS_H_
