...
// IWYU pragma: private, include "px4/msg/estimator_aid_source3d.h"


#ifndef PX4__MSG__DETAIL__ESTIMATOR_AID_SOURCE3D__FUNCTIONS_H_
#define PX4__MSG__DETAIL__ESTIMATOR_AID_SOURCE3D__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__EstimatorAidSource3d__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__EstimatorAidSource3d *
px4__msg__EstimatorAidSource3d__create(void);

/// Destroy msg/EstimatorAidSource3d message.
/**
 * It calls
 * px4__msg__EstimatorAidSource3d__fini()
 ...
 * px4__msg__EstimatorAidSource3d__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__EstimatorAidSource3d__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__ESTIMATOR_AID_SOURCE3D__FUNCTIONS_H_
