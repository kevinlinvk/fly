...
px4__msg__RegisterExtComponentRequest__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__RegisterExtComponentRequest * msg = (px4__msg__RegisterExtComponentRequest *)allocator.allocate(sizeof(px4__msg__RegisterExtComponentRequest), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4__msg__RegisterExtComponentRequest));
  bool success = px4__msg__RegisterExtComponentRequest__init(msg);
  if (!success) {
...
px4__msg__RegisterExtComponentRequest__destroy(px4__msg__RegisterExtComponentRequest * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4__msg__RegisterExtComponentRequest__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
px4__msg__RegisterExtComponentRequest__Sequence__init(px4__msg__RegisterExtComponentRequest__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__RegisterExtComponentRequest * data = NULL;

  if (size) {
    data = (px4__msg__RegisterExtComponentRequest *)allocator.zero_allocate(size, sizeof(px4__msg__RegisterExtComponentRequest), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4__msg__RegisterExtComponentRequest__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4__msg__RegisterExtComponentRequest__fini(&data[i - 1]);
      }
...
px4__msg__RegisterExtComponentRequest__Sequence__fini(px4__msg__RegisterExtComponentRequest__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4__msg__RegisterExtComponentRequest__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4__msg__RegisterExtComponentRequest__Sequence * array = (px4__msg__RegisterExtComponentRequest__Sequence *)allocator.allocate(sizeof(px4__msg__RegisterExtComponentRequest__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4__msg__RegisterExtComponentRequest__Sequence__init(array, size);
  if (!success) {
...
px4__msg__RegisterExtComponentRequest__Sequence__destroy(px4__msg__RegisterExtComponentRequest__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4__msg__RegisterExtComponentRequest__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
px4__msg__RegisterExtComponentRequest__Sequence__are_equal(const px4__msg__RegisterExtComponentRequest__Sequence * lhs, const px4__msg__RegisterExtComponentRequest__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4__msg__RegisterExtComponentRequest__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  px4__msg__RegisterExtComponentRequest__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4__msg__RegisterExtComponentRequest);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    px4__msg__RegisterExtComponentRequest * data =
      (px4__msg__RegisterExtComponentRequest *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4__msg__RegisterExtComponentRequest__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          px4__msg__RegisterExtComponentRequest__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4__msg__RegisterExtComponentRequest__copy(
