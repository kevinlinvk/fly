...
// IWYU pragma: private, include "px4/msg/radio_status.h"


#ifndef PX4__MSG__DETAIL__RADIO_STATUS__FUNCTIONS_H_
#define PX4__MSG__DETAIL__RADIO_STATUS__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__RadioStatus__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__RadioStatus *
px4__msg__RadioStatus__create(void);

/// Destroy msg/RadioStatus message.
/**
 * It calls
 * px4__msg__RadioStatus__fini()
 ...
 * px4__msg__RadioStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__RadioStatus__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__RADIO_STATUS__FUNCTIONS_H_
