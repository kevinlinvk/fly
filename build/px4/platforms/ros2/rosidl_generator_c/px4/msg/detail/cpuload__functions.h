...
// IWYU pragma: private, include "px4/msg/cpuload.h"


#ifndef PX4__MSG__DETAIL__CPULOAD__FUNCTIONS_H_
#define PX4__MSG__DETAIL__CPULOAD__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__Cpuload__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__Cpuload *
px4__msg__Cpuload__create(void);

/// Destroy msg/Cpuload message.
/**
 * It calls
 * px4__msg__Cpuload__fini()
 ...
 * px4__msg__Cpuload__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__Cpuload__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__CPULOAD__FUNCTIONS_H_
