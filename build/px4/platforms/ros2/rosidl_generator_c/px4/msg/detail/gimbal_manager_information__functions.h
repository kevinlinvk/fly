...
// IWYU pragma: private, include "px4/msg/gimbal_manager_information.h"


#ifndef PX4__MSG__DETAIL__GIMBAL_MANAGER_INFORMATION__FUNCTIONS_H_
#define PX4__MSG__DETAIL__GIMBAL_MANAGER_INFORMATION__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__GimbalManagerInformation__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__GimbalManagerInformation *
px4__msg__GimbalManagerInformation__create(void);

/// Destroy msg/GimbalManagerInformation message.
/**
 * It calls
 * px4__msg__GimbalManagerInformation__fini()
 ...
 * px4__msg__GimbalManagerInformation__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__GimbalManagerInformation__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__GIMBAL_MANAGER_INFORMATION__FUNCTIONS_H_
