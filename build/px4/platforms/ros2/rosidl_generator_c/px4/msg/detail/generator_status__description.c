  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x80, 0x04, 0x79, 0x69, 0xc3, 0x76, 0x71, 0xf2,
      0xb3, 0x54, 0x53, 0x2d, 0xa6, 0xb7, 0x1f, 0x9b,
      0xb0, 0xee, 0xce, 0x7c, 0xe2, 0x4f, 0x46, 0x48,
      0xa8, 0xf6, 0x84, 0x56, 0x6f, 0xfc, 0x0f, 0x04,
    }};
  return &hash;
}
...
static char px4__msg__GeneratorStatus__TYPE_NAME[] = "px4/msg/GeneratorStatus";

// Define type names, field names, and default values
static char px4__msg__GeneratorStatus__FIELD_NAME__timestamp[] = "timestamp";
static char px4__msg__GeneratorStatus__FIELD_NAME__status[] = "status";
static char px4__msg__GeneratorStatus__FIELD_NAME__battery_current[] = "battery_current";
static char px4__msg__GeneratorStatus__FIELD_NAME__load_current[] = "load_current";
static char px4__msg__GeneratorStatus__FIELD_NAME__power_generated[] = "power_generated";
static char px4__msg__GeneratorStatus__FIELD_NAME__bus_voltage[] = "bus_voltage";
static char px4__msg__GeneratorStatus__FIELD_NAME__bat_current_setpoint[] = "bat_current_setpoint";
static char px4__msg__GeneratorStatus__FIELD_NAME__runtime[] = "runtime";
static char px4__msg__GeneratorStatus__FIELD_NAME__time_until_maintenance[] = "time_until_maintenance";
static char px4__msg__GeneratorStatus__FIELD_NAME__generator_speed[] = "generator_speed";
static char px4__msg__GeneratorStatus__FIELD_NAME__rectifier_temperature[] = "rectifier_temperature";
static char px4__msg__GeneratorStatus__FIELD_NAME__generator_temperature[] = "generator_temperature";

static rosidl_runtime_c__type_description__Field px4__msg__GeneratorStatus__FIELDS[] = {
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__timestamp, 9, 9},
    {
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__status, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT64,
      0,
      0,
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__battery_current, 15, 15},
    {
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__load_current, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__power_generated, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__bus_voltage, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__bat_current_setpoint, 20, 20},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__runtime, 7, 7},
    {
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__time_until_maintenance, 22, 22},
    {
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__generator_speed, 15, 15},
    {
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__rectifier_temperature, 21, 21},
    {
  ...
  {
    {px4__msg__GeneratorStatus__FIELD_NAME__generator_temperature, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_INT16,
      0,
      0,
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {px4__msg__GeneratorStatus__TYPE_NAME, 23, 23},
      {px4__msg__GeneratorStatus__FIELDS, 12, 12},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
...
px4__msg__GeneratorStatus__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *px4__msg__GeneratorStatus__get_individual_type_description_source(NULL),
    constructed = true;
  }
