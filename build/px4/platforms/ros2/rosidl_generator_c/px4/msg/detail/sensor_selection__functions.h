...
// IWYU pragma: private, include "px4/msg/sensor_selection.h"


#ifndef PX4__MSG__DETAIL__SENSOR_SELECTION__FUNCTIONS_H_
#define PX4__MSG__DETAIL__SENSOR_SELECTION__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__SensorSelection__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__SensorSelection *
px4__msg__SensorSelection__create(void);

/// Destroy msg/SensorSelection message.
/**
 * It calls
 * px4__msg__SensorSelection__fini()
 ...
 * px4__msg__SensorSelection__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__SensorSelection__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__SENSOR_SELECTION__FUNCTIONS_H_
