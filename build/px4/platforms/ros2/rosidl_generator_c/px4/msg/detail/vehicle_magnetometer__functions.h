...
// IWYU pragma: private, include "px4/msg/vehicle_magnetometer.h"


#ifndef PX4__MSG__DETAIL__VEHICLE_MAGNETOMETER__FUNCTIONS_H_
#define PX4__MSG__DETAIL__VEHICLE_MAGNETOMETER__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__VehicleMagnetometer__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__VehicleMagnetometer *
px4__msg__VehicleMagnetometer__create(void);

/// Destroy msg/VehicleMagnetometer message.
/**
 * It calls
 * px4__msg__VehicleMagnetometer__fini()
 ...
 * px4__msg__VehicleMagnetometer__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__VehicleMagnetometer__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__VEHICLE_MAGNETOMETER__FUNCTIONS_H_
