...
#ifndef PX4__MSG__DETAIL__OPEN_DRONE_ID_SYSTEM__FUNCTIONS_H_
#define PX4__MSG__DETAIL__OPEN_DRONE_ID_SYSTEM__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__OpenDroneIdSystem__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__OpenDroneIdSystem *
px4__msg__OpenDroneIdSystem__create(void);

/// Destroy msg/OpenDroneIdSystem message.
/**
 * It calls
 * px4__msg__OpenDroneIdSystem__fini()
 ...
 * px4__msg__OpenDroneIdSystem__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__OpenDroneIdSystem__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__OPEN_DRONE_ID_SYSTEM__FUNCTIONS_H_
