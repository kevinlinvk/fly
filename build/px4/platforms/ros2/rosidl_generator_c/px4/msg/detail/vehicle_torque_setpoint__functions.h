...
// IWYU pragma: private, include "px4/msg/vehicle_torque_setpoint.h"


#ifndef PX4__MSG__DETAIL__VEHICLE_TORQUE_SETPOINT__FUNCTIONS_H_
#define PX4__MSG__DETAIL__VEHICLE_TORQUE_SETPOINT__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__VehicleTorqueSetpoint__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__VehicleTorqueSetpoint *
px4__msg__VehicleTorqueSetpoint__create(void);

/// Destroy msg/VehicleTorqueSetpoint message.
/**
 * It calls
 * px4__msg__VehicleTorqueSetpoint__fini()
 ...
 * px4__msg__VehicleTorqueSetpoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__VehicleTorqueSetpoint__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__VEHICLE_TORQUE_SETPOINT__FUNCTIONS_H_
