  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x81, 0x2d, 0xb0, 0xab, 0xbb, 0x1e, 0xa9, 0xbd,
      0xfd, 0x5d, 0x16, 0x59, 0x4d, 0x4b, 0x12, 0x40,
      0xc8, 0xd5, 0x6e, 0x26, 0x33, 0xbc, 0x24, 0xec,
      0x81, 0x26, 0xbe, 0xf1, 0xcc, 0x16, 0x48, 0x5b,
    }};
  return &hash;
}
...
static char px4__msg__MissionResult__FIELD_NAME__mission_id[] = "mission_id";
static char px4__msg__MissionResult__FIELD_NAME__geofence_id[] = "geofence_id";
static char px4__msg__MissionResult__FIELD_NAME__home_position_counter[] = "home_position_counter";
...
static rosidl_runtime_c__type_description__Field px4__msg__MissionResult__FIELDS[] = {
  ...
  {
    {px4__msg__MissionResult__FIELD_NAME__mission_id, 10, 10},
    {
  ...
  {
    {px4__msg__MissionResult__FIELD_NAME__geofence_id, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT32,
      0,
      0,
  ...
  {
    {px4__msg__MissionResult__FIELD_NAME__home_position_counter, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT32,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4__msg__MissionResult__FIELDS, 15, 15},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
