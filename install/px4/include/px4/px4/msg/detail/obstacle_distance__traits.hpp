...
// IWYU pragma: private, include "px4/msg/obstacle_distance.hpp"
...
inline void to_yaml(
  const px4::msg::ObstacleDistance & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::ObstacleDistance & msg)
{
