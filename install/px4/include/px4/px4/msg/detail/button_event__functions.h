...
// IWYU pragma: private, include "px4/msg/button_event.h"


#ifndef PX4__MSG__DETAIL__BUTTON_EVENT__FUNCTIONS_H_
#define PX4__MSG__DETAIL__BUTTON_EVENT__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__ButtonEvent__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__ButtonEvent *
px4__msg__ButtonEvent__create(void);

/// Destroy msg/ButtonEvent message.
/**
 * It calls
 * px4__msg__ButtonEvent__fini()
 ...
 * px4__msg__ButtonEvent__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__ButtonEvent__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__BUTTON_EVENT__FUNCTIONS_H_
