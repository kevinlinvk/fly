...
// IWYU pragma: private, include "px4/msg/vehicle_optical_flow.hpp"
...
inline void to_yaml(
  const px4::msg::VehicleOpticalFlow & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::VehicleOpticalFlow & msg)
{
