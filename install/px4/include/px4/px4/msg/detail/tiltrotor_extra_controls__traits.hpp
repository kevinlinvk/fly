...
// IWYU pragma: private, include "px4/msg/tiltrotor_extra_controls.hpp"
...
inline void to_yaml(
  const px4::msg::TiltrotorExtraControls & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::TiltrotorExtraControls & msg)
{
