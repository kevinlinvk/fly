...
// IWYU pragma: private, include "px4/msg/follow_target_estimator.hpp"
...
inline void to_yaml(
  const px4::msg::FollowTargetEstimator & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::FollowTargetEstimator & msg)
{
