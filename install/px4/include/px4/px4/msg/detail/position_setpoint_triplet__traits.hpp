...
// IWYU pragma: private, include "px4/msg/position_setpoint_triplet.hpp"
...
inline void to_yaml(
  const px4::msg::PositionSetpointTriplet & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::PositionSetpointTriplet & msg)
{
