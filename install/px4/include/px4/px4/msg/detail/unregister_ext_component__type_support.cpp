...
{
  new (message_memory) px4::msg::UnregisterExtComponent(_init);
}

void UnregisterExtComponent_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::UnregisterExtComponent *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UnregisterExtComponent_message_member_array[5] = {
  {
    ...
    offsetof(px4::msg::UnregisterExtComponent, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    25,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UnregisterExtComponent, name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UnregisterExtComponent, arming_check_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UnregisterExtComponent, mode_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::UnregisterExtComponent, mode_executor_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UnregisterExtComponent_message_members = {
  ...
  5,  // number of fields
  sizeof(px4::msg::UnregisterExtComponent),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::UnregisterExtComponent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, UnregisterExtComponent)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::UnregisterExtComponent_message_type_support_handle;
}
