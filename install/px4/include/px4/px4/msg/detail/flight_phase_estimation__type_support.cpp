...
{
  new (message_memory) px4::msg::FlightPhaseEstimation(_init);
}

void FlightPhaseEstimation_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::FlightPhaseEstimation *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FlightPhaseEstimation_message_member_array[2] = {
  {
    ...
    offsetof(px4::msg::FlightPhaseEstimation, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::FlightPhaseEstimation, flight_phase),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FlightPhaseEstimation_message_members = {
  ...
  2,  // number of fields
  sizeof(px4::msg::FlightPhaseEstimation),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::FlightPhaseEstimation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, FlightPhaseEstimation)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::FlightPhaseEstimation_message_type_support_handle;
}
