...
{
  new (message_memory) px4::msg::MessageFormatResponse(_init);
}

void MessageFormatResponse_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::MessageFormatResponse *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MessageFormatResponse_message_member_array[5] = {
  {
    ...
    offsetof(px4::msg::MessageFormatResponse, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MessageFormatResponse, protocol_version),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    50,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MessageFormatResponse, topic_name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MessageFormatResponse, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::MessageFormatResponse, message_hash),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MessageFormatResponse_message_members = {
  ...
  5,  // number of fields
  sizeof(px4::msg::MessageFormatResponse),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::MessageFormatResponse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, MessageFormatResponse)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::MessageFormatResponse_message_type_support_handle;
}
