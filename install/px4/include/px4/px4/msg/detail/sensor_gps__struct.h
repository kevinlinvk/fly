...
enum
{
  px4__msg__SensorGps__FIX_TYPE_NONE = 1
};

/// Constant 'FIX_TYPE_2D'.
enum
{
  px4__msg__SensorGps__FIX_TYPE_2D = 2
};

/// Constant 'FIX_TYPE_3D'.
enum
{
  px4__msg__SensorGps__FIX_TYPE_3D = 3
};

/// Constant 'FIX_TYPE_RTCM_CODE_DIFFERENTIAL'.
enum
{
  px4__msg__SensorGps__FIX_TYPE_RTCM_CODE_DIFFERENTIAL = 4
};

/// Constant 'FIX_TYPE_RTK_FLOAT'.
enum
{
  px4__msg__SensorGps__FIX_TYPE_RTK_FLOAT = 5
};

/// Constant 'FIX_TYPE_RTK_FIXED'.
enum
{
  px4__msg__SensorGps__FIX_TYPE_RTK_FIXED = 6
};

/// Constant 'FIX_TYPE_EXTRAPOLATED'.
enum
{
  px4__msg__SensorGps__FIX_TYPE_EXTRAPOLATED = 8
};
