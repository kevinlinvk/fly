  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xd8, 0x60, 0x5e, 0x62, 0xfa, 0x88, 0x37, 0xaf,
      0x8a, 0xca, 0xb8, 0xb4, 0x01, 0x58, 0x2a, 0x3f,
      0xe4, 0xa5, 0xad, 0x96, 0x3d, 0xbd, 0xc3, 0x67,
      0xca, 0xb8, 0x22, 0x4e, 0xb3, 0x7d, 0x9d, 0x3d,
    }};
  return &hash;
}
...
static char px4__msg__InputRc__TYPE_NAME[] = "px4/msg/InputRc";

// Define type names, field names, and default values
static char px4__msg__InputRc__FIELD_NAME__timestamp[] = "timestamp";
static char px4__msg__InputRc__FIELD_NAME__timestamp_last_signal[] = "timestamp_last_signal";
static char px4__msg__InputRc__FIELD_NAME__channel_count[] = "channel_count";
static char px4__msg__InputRc__FIELD_NAME__rssi[] = "rssi";
static char px4__msg__InputRc__FIELD_NAME__rc_failsafe[] = "rc_failsafe";
static char px4__msg__InputRc__FIELD_NAME__rc_lost[] = "rc_lost";
static char px4__msg__InputRc__FIELD_NAME__rc_lost_frame_count[] = "rc_lost_frame_count";
static char px4__msg__InputRc__FIELD_NAME__rc_total_frame_count[] = "rc_total_frame_count";
static char px4__msg__InputRc__FIELD_NAME__rc_ppm_frame_length[] = "rc_ppm_frame_length";
static char px4__msg__InputRc__FIELD_NAME__input_source[] = "input_source";
static char px4__msg__InputRc__FIELD_NAME__values[] = "values";
static char px4__msg__InputRc__FIELD_NAME__link_quality[] = "link_quality";
static char px4__msg__InputRc__FIELD_NAME__rssi_dbm[] = "rssi_dbm";

static rosidl_runtime_c__type_description__Field px4__msg__InputRc__FIELDS[] = {
  {
    {px4__msg__InputRc__FIELD_NAME__timestamp, 9, 9},
    {
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__timestamp_last_signal, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT64,
      0,
      0,
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__channel_count, 13, 13},
    {
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__rssi, 4, 4},
    {
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__rc_failsafe, 11, 11},
    {
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__rc_lost, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__rc_lost_frame_count, 19, 19},
    {
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__rc_total_frame_count, 20, 20},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT16,
      0,
      0,
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__rc_ppm_frame_length, 19, 19},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT16,
      0,
      0,
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__input_source, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT8,
      0,
      0,
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__values, 6, 6},
    {
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__link_quality, 12, 12},
    {
  ...
  {
    {px4__msg__InputRc__FIELD_NAME__rssi_dbm, 8, 8},
    {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {px4__msg__InputRc__TYPE_NAME, 15, 15},
      {px4__msg__InputRc__FIELDS, 13, 13},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *px4__msg__InputRc__get_individual_type_description_source(NULL),
    constructed = true;
  }
