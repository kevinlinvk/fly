...
// IWYU pragma: private, include "px4/msg/debug_array.h"


#ifndef PX4__MSG__DETAIL__DEBUG_ARRAY__FUNCTIONS_H_
#define PX4__MSG__DETAIL__DEBUG_ARRAY__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__DebugArray__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__DebugArray *
px4__msg__DebugArray__create(void);

/// Destroy msg/DebugArray message.
/**
 * It calls
 * px4__msg__DebugArray__fini()
 ...
 * px4__msg__DebugArray__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__DebugArray__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__DEBUG_ARRAY__FUNCTIONS_H_
