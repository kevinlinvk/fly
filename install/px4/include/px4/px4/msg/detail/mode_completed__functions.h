...
// IWYU pragma: private, include "px4/msg/mode_completed.h"


#ifndef PX4__MSG__DETAIL__MODE_COMPLETED__FUNCTIONS_H_
#define PX4__MSG__DETAIL__MODE_COMPLETED__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__ModeCompleted__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__ModeCompleted *
px4__msg__ModeCompleted__create(void);

/// Destroy msg/ModeCompleted message.
/**
 * It calls
 * px4__msg__ModeCompleted__fini()
 ...
 * px4__msg__ModeCompleted__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__ModeCompleted__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__MODE_COMPLETED__FUNCTIONS_H_
