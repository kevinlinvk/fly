...
// IWYU pragma: private, include "px4/msg/sensor_gnss_relative.hpp"
...
inline void to_yaml(
  const px4::msg::SensorGnssRelative & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::SensorGnssRelative & msg)
{
