...
{
  new (message_memory) px4::msg::OpenDroneIdSelfId(_init);
}

void OpenDroneIdSelfId_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::OpenDroneIdSelfId *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OpenDroneIdSelfId_message_member_array[4] = {
  {
    ...
    offsetof(px4::msg::OpenDroneIdSelfId, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    20,  // array size
    false,  // is upper bound
    offsetof(px4::msg::OpenDroneIdSelfId, id_or_mac),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::OpenDroneIdSelfId, description_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    23,  // array size
    false,  // is upper bound
    offsetof(px4::msg::OpenDroneIdSelfId, description),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OpenDroneIdSelfId_message_members = {
  ...
  4,  // number of fields
  sizeof(px4::msg::OpenDroneIdSelfId),
...
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::OpenDroneIdSelfId_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, OpenDroneIdSelfId)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::OpenDroneIdSelfId_message_type_support_handle;
}
