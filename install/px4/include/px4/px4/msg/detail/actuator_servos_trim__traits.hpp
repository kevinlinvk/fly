...
// IWYU pragma: private, include "px4/msg/actuator_servos_trim.hpp"
...
inline void to_yaml(
  const px4::msg::ActuatorServosTrim & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::ActuatorServosTrim & msg)
{
