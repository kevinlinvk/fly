...
#ifndef PX4__MSG__DETAIL__OPEN_DRONE_ID_SYSTEM__STRUCT_HPP_
#define PX4__MSG__DETAIL__OPEN_DRONE_ID_SYSTEM__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__OpenDroneIdSystem __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__OpenDroneIdSystem __declspec(deprecated)
#endif
...
struct OpenDroneIdSystem_
{
  ...
  // pointer types
  using RawPtr =
    px4::msg::OpenDroneIdSystem_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::OpenDroneIdSystem_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::OpenDroneIdSystem_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::OpenDroneIdSystem_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::OpenDroneIdSystem_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::OpenDroneIdSystem_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::OpenDroneIdSystem_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::OpenDroneIdSystem_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::OpenDroneIdSystem_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__OpenDroneIdSystem
    std::shared_ptr<px4::msg::OpenDroneIdSystem_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__OpenDroneIdSystem
    std::shared_ptr<px4::msg::OpenDroneIdSystem_<ContainerAllocator> const>
...
using OpenDroneIdSystem =
  px4::msg::OpenDroneIdSystem_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__OPEN_DRONE_ID_SYSTEM__STRUCT_HPP_
