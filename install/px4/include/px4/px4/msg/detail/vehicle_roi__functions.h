...
// IWYU pragma: private, include "px4/msg/vehicle_roi.h"


#ifndef PX4__MSG__DETAIL__VEHICLE_ROI__FUNCTIONS_H_
#define PX4__MSG__DETAIL__VEHICLE_ROI__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__VehicleRoi__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__VehicleRoi *
px4__msg__VehicleRoi__create(void);

/// Destroy msg/VehicleRoi message.
/**
 * It calls
 * px4__msg__VehicleRoi__fini()
 ...
 * px4__msg__VehicleRoi__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__VehicleRoi__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__VEHICLE_ROI__FUNCTIONS_H_
