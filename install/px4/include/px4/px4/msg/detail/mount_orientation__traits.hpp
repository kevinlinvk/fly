...
// IWYU pragma: private, include "px4/msg/mount_orientation.hpp"
...
inline void to_yaml(
  const px4::msg::MountOrientation & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::MountOrientation & msg)
{
