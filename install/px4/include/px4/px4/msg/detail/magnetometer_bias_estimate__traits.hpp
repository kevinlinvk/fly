...
// IWYU pragma: private, include "px4/msg/magnetometer_bias_estimate.hpp"
...
inline void to_yaml(
  const px4::msg::MagnetometerBiasEstimate & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::MagnetometerBiasEstimate & msg)
{
