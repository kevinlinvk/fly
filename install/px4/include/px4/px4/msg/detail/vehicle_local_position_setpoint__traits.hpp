...
// IWYU pragma: private, include "px4/msg/vehicle_local_position_setpoint.hpp"
...
inline void to_yaml(
  const px4::msg::VehicleLocalPositionSetpoint & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::VehicleLocalPositionSetpoint & msg)
{
