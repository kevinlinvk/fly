...
// IWYU pragma: private, include "px4/msg/uavcan_parameter_value.h"


#ifndef PX4__MSG__DETAIL__UAVCAN_PARAMETER_VALUE__FUNCTIONS_H_
#define PX4__MSG__DETAIL__UAVCAN_PARAMETER_VALUE__FUNCTIONS_H_
 ...
 * calls
 * px4__msg__UavcanParameterValue__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_px4
px4__msg__UavcanParameterValue *
px4__msg__UavcanParameterValue__create(void);

/// Destroy msg/UavcanParameterValue message.
/**
 * It calls
 * px4__msg__UavcanParameterValue__fini()
 ...
 * px4__msg__UavcanParameterValue__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4__msg__UavcanParameterValue__Sequence__fini()
 * on the array,
...
#endif  // PX4__MSG__DETAIL__UAVCAN_PARAMETER_VALUE__FUNCTIONS_H_
