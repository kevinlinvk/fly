...
// IWYU pragma: private, include "px4/msg/gimbal_device_set_attitude.hpp"
...
inline void to_yaml(
  const px4::msg::GimbalDeviceSetAttitude & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::GimbalDeviceSetAttitude & msg)
{
