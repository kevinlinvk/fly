...
// IWYU pragma: private, include "px4/msg/gimbal_manager_set_manual_control.hpp"
...
inline void to_yaml(
  const px4::msg::GimbalManagerSetManualControl & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::GimbalManagerSetManualControl & msg)
{
