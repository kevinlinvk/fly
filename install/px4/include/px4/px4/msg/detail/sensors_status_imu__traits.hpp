...
// IWYU pragma: private, include "px4/msg/sensors_status_imu.hpp"
...
inline void to_yaml(
  const px4::msg::SensorsStatusImu & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::SensorsStatusImu & msg)
{
